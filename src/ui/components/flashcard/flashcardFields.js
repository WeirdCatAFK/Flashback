...
/** The one-line answer a list row shows under the front: the graded text, never the notes. */
export function cardAnswerLine(card) {
  return (card.card_type === 'type_answer' ? typeAnswerParts(card).answer : card.backText) || '';
}
