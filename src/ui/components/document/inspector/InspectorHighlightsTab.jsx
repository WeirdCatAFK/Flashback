/**
 * InspectorHighlightsTab — the document's highlights with the cards each one
 * anchors; jump, make a card, or delete.
 */
                ...
                {cards.map((card) => {
                  ...
                  return (
                    <div key={card.globalHash} className="hl-card-item">
                      <span className="badge">{cardTypeShortLabel(ct, t)}</span>
