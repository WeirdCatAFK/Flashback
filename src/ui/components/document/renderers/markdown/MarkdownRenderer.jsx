/**
 * MarkdownRenderer — the TipTap editor for .md files: markdown in and out,
 * inline <mark> highlights, and flashback:// links that never become an href
 * (Chromium hands unregistered protocols to the OS before JS runs). Built on
 * useHighlightableRenderer.
 */
...
import ConflictBanner from '../../../base/ConflictBanner';
import { getDocumentByHash } from '../../../../api/documents';
import { onFlashbackNavigate } from '../../../../api/desktop';
...
export default function MarkdownRenderer({ onNavigate, initialProgress, onProgress, progressRef, ...props }) {
  ...
  useEffect(() => onFlashbackNavigate((hash) => {
