export default function IconFileTxt({ size = 13 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 12 16" fill="none" aria-hidden="true" style={{ flexShrink: 0 }}>
      ...
      <rect x="2" y="7"    width="7.5" height="0.9" rx="0.3" fill="currentColor" opacity="0.55"/>
      <rect x="2" y="8.9"  width="7.5" height="0.9" rx="0.3" fill="currentColor" opacity="0.55"/>
      <rect x="2" y="10.8" width="7.5" height="0.9" rx="0.3" fill="currentColor" opacity="0.55"/>
      <rect x="2" y="12.7" width="4.5" height="0.9" rx="0.3" fill="currentColor" opacity="0.55"/>
    </svg>
  );
}
